                    ...
                    flip: {
                        ...
                        top: function (e, t) {
                            ...
                            0 > u
                                ...
                                : d > 0 && ((i = e.top - t.collisionPosition.marginTop + p + f + m - h), (i > 0 || d > r(i)) && (e.top += p + f + m));
                        },
                    },
                    flipfit: {
                        left: function () {
                        ...
                        menufocus: function (t, i) {
                            ...
                            return this.isNewMenu && ((this.isNewMenu = !1), t.originalEvent && /^mouse/.test(t.originalEvent.type))
                                ...
                                : ((n = i.item.data("ui-autocomplete-item")),
                                  ...
                                  s && e.trim(s).length && (this.liveRegion.children().hide(), e("<div>").text(s).appendTo(this.liveRegion)),
                                  void 0);
                        },
                ...
                o !== r && "HTML" !== o.tagName
                    ...
                    : ((n.axis && "x" === n.axis) ||
                          (t.pageY - e(r).scrollTop() < n.scrollSensitivity
                              ...
                              : e(window).height() - (t.pageY - e(r).scrollTop()) < n.scrollSensitivity && (a = e(r).scrollTop(e(r).scrollTop() + n.scrollSpeed))),
                      (n.axis && "y" === n.axis) ||
                          (t.pageX - e(r).scrollLeft() < n.scrollSensitivity
                              ? (a = e(r).scrollLeft(e(r).scrollLeft() - n.scrollSpeed))
                              : e(window).width() - (t.pageX - e(r).scrollLeft()) < n.scrollSensitivity && (a = e(r).scrollLeft(e(r).scrollLeft() + n.scrollSpeed)))),
                ...
                c &&
                    ...
                    /document/.test(d) || d === document
                        ? ((h.containerOffset = { left: 0, top: 0 }),
                          ...
                          (h.parentData = { element: e(document), left: 0, top: 0, width: e(document).width(), height: e(document).height() || document.body.parentNode.scrollHeight }))
                        : ((t = e(c)),
                          (i = []),
            ...
            resize: function (t) {
                ...
                c[0] !== document && /static/.test(c.css("position")) && (d = h),
                    l.left < (o._helper ? h.left : 0) &&
                        ((o.size.width = o.size.width + (o._helper ? o.position.left - h.left : o.position.left - d.left)), u && ((o.size.height = o.size.width / o.aspectRatio), (p = !1)), (o.position.left = r.helper ? h.left : 0)),
                    l.top < (o._helper ? h.top : 0) &&
                        ((o.size.height = o.size.height + (o._helper ? o.position.top - h.top : o.position.top)), u && ((o.size.width = o.size.height * o.aspectRatio), (p = !1)), (o.position.top = o._helper ? h.top : 0)),
                ...
                (s.grid = h),
                    ...
                    /^(se|s|e)$/.test(r)
                        ...
                        : ((0 >= f - u || 0 >= p - l) && (t = i._getPaddingPlusBorderDimensions(this)),
                          f - u > 0 ? ((i.size.height = f), (i.position.top = o.top - c)) : ((f = u - t.height), (i.size.height = f), (i.position.top = o.top + a.height - f)),
                          p - l > 0 ? ((i.size.width = p), (i.position.left = o.left - d)) : ((p = l - t.width), (i.size.width = p), (i.position.left = o.left + a.width - p)));
            },
        }),
        e.ui.resizable,
        e.widget("ui.dialog", {
            ...
            _makeDraggable: function () {
                ...
                this.uiDialog.draggable({
                    ...
                    stop: function (n, a) {
                        ...
                        (s.position = { my: "left top", at: "left" + (o >= 0 ? "+" : "") + o + " " + "top" + (r >= 0 ? "+" : "") + r, of: i.window }),
                ...
                return s && (s.currentItem || s.element)[0] !== this.element[0]
                    ? (this.element
                      ...
                      n
                          ...
                          ? (this.options.activeClass && this.element.removeClass(this.options.activeClass), this.options.hoverClass && this.element.removeClass(this.options.hoverClass), this._trigger("drop", t, this.ui(s)), this.element)
                          : !1)
                    : !1;
            },
            ui: function (e) {
    ...
    (e.effects = { effect: {} }),
        ...
        (e.effects.effect.size = function (t, i) {
            ...
            "show" === p && o.show(),
                ...
                ("box" === m || "both" === m) &&
                    (a.from.y !== a.to.y && ((y = y.concat(d)), (o.from = e.effects.setTransition(o, d, a.from.y, o.from)), (o.to = e.effects.setTransition(o, d, a.to.y, o.to))),
                    a.from.x !== a.to.x && ((y = y.concat(c)), (o.from = e.effects.setTransition(o, c, a.from.x, o.from)), (o.to = e.effects.setTransition(o, c, a.to.x, o.to)))),
        ...
        (e.effects.effect.puff = function (t, i) {
            ...
            e.extend(t, { effect: "scale", queue: !1, fade: !0, mode: n, complete: i, percent: a ? o : 100, from: a ? h : { height: h.height * r, width: h.width * r, outerHeight: h.outerHeight * r, outerWidth: h.outerWidth * r } }),
                s.effect(t);
        }),
                ...
                (this.opos = [t.pageX, t.pageY]),
                    this.options.disabled ||
                        ...
                        this.selectees.filter(".ui-selected").each(function () {
                            ...
                            (s.startselected = !0),
                                t.metaKey || t.ctrlKey || (s.$element.removeClass("ui-selected"), (s.selected = !1), s.$element.addClass("ui-unselecting"), (s.unselecting = !0), i._trigger("unselecting", t, { unselecting: s.element }));
                        }),
                        e(t.target)
                            .parents()
                            .addBack()
                                    ...
                                    : (i.selecting &&
                                      ...
                                      i.selected &&
                                          (t.metaKey ||
                                              t.ctrlKey ||
                                              i.startselected ||
                                              (i.$element.removeClass("ui-selected"), (i.selected = !1), i.$element.addClass("ui-unselecting"), (i.unselecting = !0), s._trigger("unselecting", t, { unselecting: i.element })))));
                        }),
                        !1
                    );
                }
        ...
        e.widget("ui.selectmenu", {
                    ...
                    (this.menuInstance = this.menu
                        .menu({
                            ...
                            focus: function (e, i) {
                                ...
                                null != t.focusIndex && s.index !== t.focusIndex && (t._trigger("focus", e, { item: s }), t.isOpen || t._select(s, e)),
            ...
            _renderMenu: function (t, i) {
                ...
                e.each(i, function (i, a) {
                    a.optgroup !== n && (e("<li>", { class: "ui-selectmenu-optgroup ui-menu-divider" + (a.element.parent("optgroup").prop("disabled") ? " ui-state-disabled" : ""), text: a.optgroup }).appendTo(t), (n = a.optgroup)),
        ...
        e.widget("ui.sortable", e.ui.mouse, {
            ...
            _mouseStart: function (t, i, s) {
                ...
                if (
                    ...
                    o.cursor &&
                        "auto" !== o.cursor &&
                        ((a = this.document.find("body")), (this.storedCursor = a.css("cursor")), a.css("cursor", o.cursor), (this.storedStylesheet = e("<style>*{ cursor: " + o.cursor + " !important; }</style>").appendTo(a))),
                ...
                return (
                    e.ui.ddmanager && (e.ui.ddmanager.current = this), e.ui.ddmanager && !o.dropBehaviour && e.ui.ddmanager.prepareOffsets(this, t), (this.dragging = !0), this.helper.addClass("ui-sortable-helper"), this._mouseDrag(t), !0
                );
            },
            _mouseDrag: function (t) {
                var i,
                        ...
                        for (n = e(c[i], this.document[0]), s = n.length - 1; s >= 0; s--)
                            (a = e.data(n[s], this.widgetFullName)),
                                a &&
                                    a !== this &&
                                    !a.options.disabled &&
                                    (d.push([e.isFunction(a.options.items) ? a.options.items.call(a.element[0], t, { item: this.currentItem }) : e(a.options.items, a.element), a]), this.containers.push(a));
                ...
                for (i = this.items.length - 1; i >= 0; i--)
                    (s = this.items[i]),
                        (s.instance !== this.currentContainer && this.currentContainer && s.item[0] !== this.currentItem[0]) ||
                            ((n = this.options.toleranceElement ? e(this.options.toleranceElement, s.item) : s.item), t || ((s.width = n.outerWidth()), (s.height = n.outerHeight())), (a = n.offset()), (s.left = a.left), (s.top = a.top));
                    ...
                    if (1 === this.containers.length) this.containers[p].containerCache.over || (this.containers[p]._trigger("over", t, this._uiHash(this)), (this.containers[p].containerCache.over = 1));
                        ...
                        for (n = 1e4, a = null, u = c.floating || this._isFloating(this.currentItem), o = u ? "left" : "top", r = u ? "width" : "height", d = u ? "clientX" : "clientY", s = this.items.length - 1; s >= 0; s--)
                            e.contains(this.containers[p].element[0], this.items[s].item[0]) &&
                                ...
                                ((h = this.items[s].item.offset()[o]), (l = !1), t[d] - h > this.items[s][r] / 2 && (l = !0), n > Math.abs(t[d] - h) && ((n = Math.abs(t[d] - h)), (a = this.items[s]), (this.direction = l ? "up" : "down")));
        ...
        e.widget("ui.tooltip", {
            ...
            _create: function () {
                this._on({ mouseover: "open", focusin: "open" }),
                    ...
                    (this.liveRegion = e("<div>").attr({ role: "log", "aria-live": "assertive", "aria-relevant": "additions" }).addClass("ui-helper-hidden-accessible").appendTo(this.document[0].body));
            },
            _setOption: function (t, i) {
                var s = this;
                return "disabled" === t
